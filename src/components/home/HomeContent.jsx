...
function HomeContent() {
  ...
  return (
    <div className="container sm:mx-auto w-10/12 mt-8 pr-2 outline outline-2 outline-gray-100 rounded-md">
      <div className="flex">
        ...
        <div
          className="hidden w-5/12  bg-cover lg:flex  bg-right z-10 relative"
          style={{ backgroundImage: 'url("./images/home.png")' }}
        >
          <button
            type="button"
            className="bg-orange rounded-[10px] text-xs w-44 h-10 text-[#FFFFFF] absolute inline-block bottom-[20px] xl:left-[40%] lg:left-[20%] hover:scale-110 ease-in-out transition-all"
