...
function HomeContent() {
  ...
  return (
    <div className="container sm:mx-auto w-full  mt-16 pr-2 md:md-0 md:mx-auto lg:mr-1 lg:ml-0 xs:mx-auto">
      <div className="flex ">
        <div className="w-full z-10 mx-auto place-self-center md:w-full xl:w-7/12">
          <h2 className="text-5xl xs:text-4xl sm:text-6xl text-orange">
            Student Teach
          </h2>
          <h4 className="font-semibold text-base xs:text-[15px] sm:text-2xl text-black mt-2 sm:mt-9 py-0.5">
        ...
        <div
          className="hidden w-5/12 bg-cover lg:flex bg-right scale-150 mr-32 -z-10"
