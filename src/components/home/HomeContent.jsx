...
function HomeContent() {
  ...
  return (
    <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} pt-5`}>
      <div className="container mx-auto w-full pt-8 lg:outline outline-2 outline-gray-100 rounded-md transition-all ease-in-out duration-300  text-center lg:text-left bg-white ">
        <div className="flex">
